...
<head>
	...
	<title>Alterar Requisição &middot; AV</title>
...
<body>
			...
			<div class="collapse navbar-collapse" id="dropdown">
				<ul class="navbar-nav me-auto mb-2 mb-md-0">
					<li class="nav-item dropdown">
						<a class="nav-link posicao active tasks dropdown-toggle on" id="dropdown04" data-bs-toggle="dropdown" aria-expanded="false">Tarefas</a>
						<ul class="dropdown-menu mx-0 shadow" style="width: 12vw;">
							<li>
								<a href="../index.php" class="dropdown-item ativo d-flex gap-2 align-items-center">
									<img class="bi ico-navbar"src="../img/ico/tasks.png">
									Consultar
								</a>
							</li>
							<li>
								<a href="#" class="dropdown-item d-flex gap-2 align-items-center">
	...
	<br>
	<div class="box">
		<p class="subtitulo">Atualização de requisição</p>
		<hr><br>		
		<form action="../php/alter.php" method="post" id="form">
			<fieldset class="cad">
				<p class="reqData">Requisição #<span id="idReq">[id]</span></p>

				<div class="name">
					<input type="text" name="name" placeholder="Nome da requisição" required value="">
				</div>
				...
				<div style="display: inline;" class="matriz">
					<select name="urg" id="urg" required>
						<option disabled>É urgente?</option>
					...
					<select name="imp" id="imp" required>
						<option disabled>É importante?</option>
				...
				<div class="prazo-setor">
					<input type="date" name="prazo" required placeholder="Prazo limite" value="">

					<select name="sector" id="sector" required>
						<option disabled>Setor responsável</option>
				...
				<div class="requerente">
					<select name="requerente" id="requerente" required>
						<option disabled>Quem é o requerente?</option>
